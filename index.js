/**
 * @author: Francesco Napoletano <fnapoletano@ebay.com>
 **/
...
if (!(APP_SECRET && VALIDATION_TOKEN && PAGE_ACCESS_TOKEN && WIT_ACCESS_TOKEN)) {
...
function receivedMessage(event) {
  ...
  var messageText = (message.text) ? message.text.toLowerCase().trim() : "";
...
function sendKittenMessage(recipientId) {
  ...
  var randomWidth = _.random(300, 600);
  var randomHeight = _.random(300, 600);
